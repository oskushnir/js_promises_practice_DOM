...
const firstPromise = new Promise((resolve, reject)=>{
    ...
    body.addEventListener("click", ()=>{
        ...
        if (hasFirst) resolve("First promise was resolved");
        hasFirst = false;
    });
});
firstPromise.then(()=>{
...
const secondPromise = new Promise((resolve)=>{
    let hasSecond = true;
    body.addEventListener("click", ()=>{
        if (hasSecond) resolve("Second promise was resolved");
        hasSecond = false;
    });
...
const thirdPromise = new Promise((resolve)=>{
    ...
    body.addEventListener("click", ()=>{
        leftClick = true;
        if (hasThirdLeft) checkBothClicks();
        hasThirdLeft = false;
    });
    body.addEventListener("contextmenu", ()=>{
        rightClick = true;
        if (hasThirdRight) checkBothClicks();
        hasThirdRight = false;
    });
